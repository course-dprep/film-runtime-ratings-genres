...
This section provides an overview of the two raw IMDb data files: `title.basics` and `title.ratings`. The structure, rows, columns, and variable types will explored and previews and summaries of the data will be provided to get a good understanding of what the raw data looks like. It is important to understand the content of the files before merging, cleaning, and filtering them.

### 4.1 Exploring `title.basics`
...
Genre is the moderator in this research and it is therefore important to have some insight into this variable. The following table shows the top 5 most common genres in the dataset. 
